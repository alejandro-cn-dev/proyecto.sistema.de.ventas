 ...
 * @author ALUMNO
 */
public class ModificaEmpleado extends javax.swing.JInternalFrame {
private Empleado_ABMC crud;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(esNumero(ci) && esNumero(id)){
            CI=Integer.parseInt(ci);  
            ID=Integer.parseInt(id);
        }else{
            JOptionPane.showMessageDialog(null, "Los campos ID y CI deben ser numero");
            return;
        } 
        if(crud.update(ID,nombre, apellido, CI, fecha)){
            JOptionPane.showMessageDialog(this, "Datos actualizados con exito.", "Exito", JOptionPane.INFORMATION_MESSAGE);
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            jTextField5.setText("");
