...
public class AgregarCliente extends javax.swing.JInternalFrame {    
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "CI", "RUN", "NIT" }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(esNumero(id) && esNumero(telefono)){
            ID=Integer.parseInt(id);
            tel=Integer.parseInt(telefono);
        }else{
            JOptionPane.showMessageDialog(null, "los campos ID y telefono deben ser numero");
            return;
        } 
        if(crud.insert(ID, TipoId, nombre, apellido, direccion, fecha, tel, email)){
            JOptionPane.showMessageDialog(this, "Cliente registrado con exito.", "Extio", JOptionPane.INFORMATION_MESSAGE);
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            jTextField5.setText("");
